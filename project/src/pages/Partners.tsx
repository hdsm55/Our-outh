  ...
  return (
    <>
      <Meta
        ...
        description={t('partners.description', 'Meet the organizations working with us to empower youth globally')}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-white/80 mb-6 max-w-2xl mx-auto">
              {t('partners.become_partner_desc', 'Join our global network of organizations committed to youth empowerment')}
            </p>
            <Link to="/contact" className="btn btn-lg bg-white text-primary hover:bg-white/90 gap-2">
