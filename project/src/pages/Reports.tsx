...
import { Download, FileText, ExternalLink, Calendar, ChevronDown } from 'lucide-react';
  ...
  return (
    <>
      <Meta
        ...
        description={t('reports.description', 'Access our annual reports, financial statements, and impact assessments')}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-base-content/80 max-w-2xl mx-auto">
              {t('reports.subtitle', 'Transparency and accountability in our operations')}
            </p>
          </motion.div>
          ...
          <div className="mb-8">
            <div className="flex flex-wrap gap-4 justify-center">
              <button
                ...
                className={`btn ${selectedYear === 'all' ? 'btn-primary' : 'btn-ghost'}`}
              >
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-base-content/80">
                        {report.description[i18n.language]}
                      </p>
                    </div>
                    <ChevronDown 
          ...
          {filteredReports.length === 0 && (
            <div className="text-center py-12">
              <p className="text-lg text-base-content/60">
                {t('reports.no_reports', 'No reports found for the selected year')}
              </p>
              <button
                onClick={() => setSelectedYear('all')}
