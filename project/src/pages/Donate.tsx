  ...
  return (
    <>
      <Meta
        ...
        description={t('donate.description', 'Make a difference by supporting our youth empowerment initiatives')}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-base-content/80 max-w-2xl mx-auto">
              {t('donate.subtitle', 'Your contribution helps empower youth globally')}
            </p>
          </motion.div>
              ...
              <div className="bg-base-200 rounded-xl shadow-xl p-8">
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <p className="text-sm text-base-content/60 text-center">
                    {t('donate.secure_payment', 'Secure payment powered by Stripe')}
                  </p>
                </form>
              </div>
            </motion.div>
            ...
            >
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-base-content/80">
                        {t('donate.impact.education.description', 'Support educational programs and workshops for underprivileged youth')}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-base-content/80">
                        {t('donate.impact.mentorship.description', 'Enable mentorship programs connecting youth with experienced leaders')}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-base-content/80">
                        {t('donate.impact.resources.description', 'Provide essential resources and tools for youth development')}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-base-200 rounded-xl shadow-xl p-8">
                <h2 className="text-2xl font-bold mb-4">
                  {t('donate.tax.title', 'Tax Deductible')}
                </h2>
                <p className="text-base-content/80">
                  {t('donate.tax.description', 'All donations are tax-deductible. You will receive a receipt for your records.')}
                </p>
              </div>
            </motion.div>
          </div>
