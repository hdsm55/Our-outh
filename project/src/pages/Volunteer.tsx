...
import { Heart, Users, Globe, Calendar, Mail, Phone, MapPin } from 'lucide-react';
  ...
  const opportunities = [
    {
      ...
      description: 'Help organize and participate in local community service projects',
      commitment: '4-6 hours/week'
    },
    {
      icon: Users,
      title: 'Mentorship',
      description: 'Guide and support youth in their personal and professional development',
  ...
  return (
    <>
      <Meta
        ...
        description={t('volunteer.description', 'Join our global community of volunteers and make a difference')}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-base-content/80 max-w-2xl mx-auto">
              {t('volunteer.subtitle', 'Join our community of passionate volunteers making a difference globally')}
            </p>
          </motion.div>
            ...
            >
              <div className="bg-base-200 rounded-xl shadow-xl p-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {opportunities.map(opportunity => (
                        <label key={opportunity.title} className="flex items-center gap-2">
                          <input
                            type="checkbox"
                            name="interests"
                  ...
                  <div>
                    <label htmlFor="availability" className="block text-sm font-medium text-base-content mb-2">
                    ...
                    >
                      <option value="">{t('volunteer.form.select_availability', 'Select availability')}</option>
                      <option value="weekdays">{t('volunteer.form.weekdays', 'Weekdays')}</option>
                      <option value="weekends">{t('volunteer.form.weekends', 'Weekends')}</option>
                      <option value="flexible">{t('volunteer.form.flexible', 'Flexible')}</option>
                    </select>
                  </div>
                  ...
                  <div>
                    <label htmlFor="message" className="block text-sm font-medium text-base-content mb-2">
                      {t('volunteer.form.message', 'Why do you want to volunteer?')}
                    </label>
                    <textarea
                      id="message"
                      name="message"
            ...
            >
              ...
              <div className="bg-base-200 rounded-xl shadow-xl p-8">
                <h2 className="text-2xl font-bold mb-6">
                  {t('volunteer.opportunities.title', 'Volunteer Opportunities')}
                </h2>
                    ...
                    <div key={index} className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 text-sm text-base-content/60">
                          ...
                          {t('volunteer.commitment', 'Time Commitment')}: {opportunity.commitment}
                        </div>
                      </div>
                    </div>
                  ))}
              ...
              <div className="bg-base-200 rounded-xl shadow-xl p-8">
                ...
                <ul className="space-y-4 list-disc list-inside text-base-content/80">
                  <li>{t('volunteer.requirements.age', 'Must be 18 years or older')}</li>
                  <li>{t('volunteer.requirements.commitment', 'Minimum 3-month commitment')}</li>
                  <li>{t('volunteer.requirements.language', 'Proficiency in English')}</li>
                  <li>{t('volunteer.requirements.training', 'Attend required training sessions')}</li>
                </ul>
              </div>
